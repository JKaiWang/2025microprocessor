# 1 "signed16bitmultiplexer.asm"
# 1 "<built-in>" 1
# 1 "signed16bitmultiplexer.asm" 2
List p=18f4520
...
TOSU equ 0FFFh
# 3 "signed16bitmultiplexer.asm" 2
...
;-------------------------------------------------
# 24 "signed16bitmultiplexer.asm"
GOTO main
_mul16:
    CLRF 0x18 ; sign flag ; clear sign flag

    ; handle sign of A
    BTFSC 0x10,7 ; if A negative
    INCF 0x18 ; sign flag,F ; 0x18 ; sign flag++
    BTFSC 0x10,7
    RCALL NegA ; make A positive

    ; handle sign of B
    BTFSC 0x12,7 ; if B negative
    XORLW 1 ; toggle sign if needed
    BTFSC 0x12,7
    RCALL NegB ; make B positive
    ; XOR result of 0x12 test into 0x18 ; sign flag
    BTFSC 0x12,7
    INCF 0x18 ; sign flag,F
    ...
    MOVF 0x11,W
    MULWF 0x13
    MOVFF PRODL,0x23 ; LSB ; lowest byte
    MOVFF PRODH,0x22
    ...
    ;----------------------
    ; if 0x18 ; sign flag != 0, negate result (two's complement)
    ;----------------------
    MOVF 0x18 ; sign flag,W
    BTFSC STATUS,2
    RETURN ; no sign change

    ; invert 0x23 ; LSB.. 0x20 ; MSB
    COMF 0x23 ; LSB,F
    COMF 0x22,F
    COMF 0x21,F
    COMF 0x20 ; MSB,F
