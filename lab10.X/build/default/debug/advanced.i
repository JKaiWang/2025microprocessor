...
# 319 "/Users/jkaiwang/.mchp_packs/Microchip/PIC18Fxxxx_DFP/1.7.171/xc8/pic/include/pic18_chip_select.h" 3
...
# 320 "/Users/jkaiwang/.mchp_packs/Microchip/PIC18Fxxxx_DFP/1.7.171/xc8/pic/include/pic18_chip_select.h" 2 3
...
volatile unsigned int ms_accum = 0;
volatile unsigned int delay_ms = 1000;
volatile unsigned char tick = 0;



volatile char uart_buf[8];
...
static __attribute__((inline)) void UART_putc(char c) {
...
void apply_new_delay_from_buffer(void) {
    unsigned int new_delay = delay_ms;
    ...
    if (uart_buf[0] == '0' && uart_buf[1] == '.' &&
        ...
        (uart_buf[3] == '\0'))
    {
        unsigned char d = uart_buf[2] - '0';
        new_delay = (unsigned int)d * 100;
    }
...
void main(void) {
    ...
    UART_puts("Delay=1.0s\r\n");
    UART_puts("Enter new delay (0.1~1.0):\r\n");
