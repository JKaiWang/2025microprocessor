...
# 362 "2024_3b.c"
    ...
    while (1) {
        ...
        if(temp <= 146 ){
            ...
            if(state != 1) printf("DDL\n");

            state = 1;
        }
        else if(temp <= 292){
            set_LED(2);
            if(state != 2) printf("DLD\n");
            state = 2;
        }
        else if(temp <=438){
            set_LED(3);
            if(state != 3) printf("DLL\n");
            state = 3;
        }
        else if(temp <= 584){
            set_LED(4);
            if(state != 4) printf("LDD\n");
            state = 4;
        }
        else if(temp <= 730){
            set_LED(5);
            if(state != 5) printf("LDL\n");
            state = 5;
        }
        else if(temp <= 876){
            set_LED(6);
            if(state != 6) printf("LLD\n");
            state = 6;
        }
        else{
            set_LED(7);
            if(state != 7) printf("LLL\n");
            state = 7;
        }
