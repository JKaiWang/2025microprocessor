...
# 181 "2022_1a_timer1.c"
    ...
    PIE1bits.RCIE = 1;
    IPR1bits.RCIP = 0;
# 212 "2022_1a_timer1.c"
    ADCON0bits.GO = 1;
}
void Init_Timer1_4MHz_1ms(void)
{
...
void variable_register_changed(int value) {
# 362 "2022_1a_timer1.c"
}

void keyboard_input(char *str) {
# 375 "2022_1a_timer1.c"
}

void main() {
    Initialize();
    s = s*200;
# 398 "2022_1a_timer1.c"
    char str[100];
    Init_Timer1_4MHz_1ms();
    while (1) {
