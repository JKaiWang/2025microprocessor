...
_Bool btn_interr = 0;
volatile int x = 4;
volatile int s = 65535;
volatile int start_count_down = 0 ;
...
void Init_Timer2_4MHz_1ms(void)
{
...
# 357 "2022_1b.c"
    float temp = strtof(str,0);
    if(temp == 1 || temp == 0.5 || temp== 0.25){
        start_count_down = 1;
        change_state = 1;
        temp = temp*200;
        int temp1 = (int)temp;
        s = temp1;
        printf("s: %d start_count_down: %d\n" ,s , start_count_down);
    }
}
