...
{
    // Timer1 config: 1 sec interrupt at Fosc=4MHz
    // Fosc/4 = 1MHz → tick = 1us
    // We use prescaler = 1:8 → tick = 8us
    // Needed ticks for 1 sec = 1,000,000 / 8 = 125000
    // preload = 65536 - 125000 = −59500 = 0x900C
    ...
    T1CONbits.TMR1ON = 0;  // off at beginning (題目規定 button 按下才開始)
}
