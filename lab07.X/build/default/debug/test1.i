...
# 1 "/Applications/microchip/xc8/v2.45/pic/include/proc/pic18f4520.inc" 1 3
# 47 "/Applications/microchip/xc8/v2.45/pic/include/proc/pic18f4520.inc" 3
PORTA equ 0F80h
...
; CONFIG1H
  CONFIG OSC = INTIO67 ; Oscillator Selection bits (Internal oscillator block, port function on ((PORTA) and 0FFh), 6, a and ((PORTA) and 0FFh), 7, a)
  CONFIG FCMEN = OFF ; Fail-Safe Clock Monitor Enable bit (Fail-Safe Clock Monitor disabled)
  CONFIG IESO = OFF ; Internal/External Oscillator Switchover bit (Oscillator Switchover mode disabled)

; CONFIG2L
  CONFIG PWRT = OFF ; Power-up Timer Enable bit (PWRT disabled)
  CONFIG BOREN = SBORDIS ; Brown-out Reset Enable bits (Brown-out Reset enabled in hardware only (((RCON) and 0FFh), 6, a is disabled))
...
; CONFIG3H
  CONFIG CCP2MX = PORTC ; CCP2 MUX bit (CCP2 input/output is multiplexed with ((PORTC) and 0FFh), 1, a)
...
; ?? ((PORTB) and 0FFh), 0, a ???
    BTFSC INTCON, ((INTCON) and 0FFh), 1, a
    GOTO Handle_INT0
...
Handle_INT0:
 ...
 BCF INTCON, ((INTCON) and 0FFh), 1, a ; ????
 DELAY d'111', d'140'
 BCF PIR1, ((PIR1) and 0FFh), 1, a ; ??????((PIR1) and 0FFh), 1, a?? (??flag bit)
 RETFIE
    initial_stateA:
 MOVLW b'00000000'
 MOVWF counter
...
Initial:
    ...
    ; ???????
    BCF INTCON, ((INTCON) and 0FFh), 1, a
    BSF INTCON, ((INTCON) and 0FFh), 4, a

    BSF RCON, ((RCON) and 0FFh), 7, a
    BSF INTCON, ((INTCON) and 0FFh), 7, a
    BCF PIR1, ((PIR1) and 0FFh), 1, a ; ????TIMER2??????????((PIR1) and 0FFh), 1, a?((PIE1) and 0FFh), 1, a?((IPR1) and 0FFh), 1, a?
    BSF IPR1, ((IPR1) and 0FFh), 1, a
    BSF PIE1 , ((PIE1) and 0FFh), 1, a
