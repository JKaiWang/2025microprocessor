...
ISR:
    ...
    org 0x08
    BTG mode ,0
    BCF INTCON, 1 ; ((INTCON) and 0FFh), 1, a = 1
    RETFIE
...
Initial:
    ...
    CLRF LATD
    BSF TRISB, 0
    BCF RCON, 7 ; ((RCON) and 0FFh), 7, a = bit7
    BCF INTCON, 1 ; ((INTCON) and 0FFh), 1, a =1 ; ??Interrupt flag bit??
    BSF INTCON, 7 ; ((INTCON) and 0FFh), 7, a = 7 ; ?Global interrupt enable bit??
    BSF INTCON, 4 ; ((INTCON) and 0FFh), 4, a =4 ; ?interrupt0 enable bit ?? (((PORTB) and 0FFh), 0, a?((PORTB) and 0FFh), 0, a pin???]
